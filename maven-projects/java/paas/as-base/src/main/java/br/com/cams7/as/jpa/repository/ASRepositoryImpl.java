 ...
 */
public abstract class ASRepositoryImpl<E extends BaseEntity<ID>, ID extends Serializable>
		extends BaseRepositoryImpl<E, ID> implements ASRepository<E, ID> {

	public ASRepositoryImpl() {
		super();
	}
